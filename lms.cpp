...
// gotoxy implementation for Windows
#include <windows.h>
...
public:
    ...
    char *retbname() // New getter for book name
    {
        return bname;
    }
    char *retaname() // New getter for author name
    {
        return aname;
    }
    void report()
...
void searchBooks()
{
    ...
    while (fp.read((char *)&bk, sizeof(book)))
    {
        if (strstr(bk.retbname(), searchTerm) != NULL || strstr(bk.retaname(), searchTerm) != NULL)
        {
            bk.report();
            found = true;
        }
...
void adminmenu()
{
    ...
    cout << "\\n\\n\\n\\t11.SEARCH BOOKS";                // New Option
    cout << "\\n\\n\\n\\t12.BACK TO MAIN MENU";           // Shifted from 11
    cout << "\\n\\n\\n\\tPLEASE ENTER YOUR CHOICE(1-12)"; // Updated range
    cin >> ch2;
    switch (ch2)
    {
    case 1:
    ...
    case 10:
        ...
        break;
    case 11:
        searchBooks(); // Call the new search function
        break;
    case 12: // Was 11
        return;
    default:
